...
wrkname3=strcat('C:\Users\srinath8n\Documents\MATLAB\FYP\',wrkn3,'.mat');
load(wrkname3);
...
% 
% str1=strcat('C:\Users\srinath8n\Documents\MATLAB\FYP\outputs\col',timg,'_gnd.tiff');
% imwrite(it1,str1);
% 
% it2=ycbcr2rgb(uint8(imtest_lr(1:outsize(1),1:outsize(2),:)));
% 
% st2=strcat('C:\Users\srinath8n\Documents\MATLAB\FYP\outputs\col',timg,'_lr_z',num2str(zom),'.tiff');
% imwrite(it2,st2);
% 
% it3=ycbcr2rgb(uint8(imsr));            
% 
% str3=strcat('C:\Users\srinath8n\Documents\MATLAB\FYP\outputs\col',timg,'_out_',wrkn2,'.tiff');
% imwrite(it3,str3);
% 
